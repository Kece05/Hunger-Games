...
class GameScene: SKScene, SKPhysicsContactDelegate {
        ...
        for i in 1...tot-1 {
            if !pm {
                ...
                if copy.texture!.name == "mountainC" {
                    copy.scale(to: CGSize(width: copy.size.width/6, height: copy.size.height/6))
                    for i in 1...3 {
                    ...
                    copy.scale(to: CGSize(width: copy.size.width/3, height: copy.size.height/3))
                }
    ...
    func NewCar() {
        ...
        if Name1.texture!.name == "mountainC" {
            Name1.scale(to: CGSize(width: Name1.size.width/6, height: Name1.size.height/6))
            for i in 1...3 {
            ...
            Name1.scale(to: CGSize(width: Name1.size.width/3, height: Name1.size.height/3))
        }
    ...
    func returnToMainMenu() {
        ...
        if victoryRoyale && hungerM && damageM != 0 && CMD {
            lol.set(kills*15, forKey: "place")
        } else if victoryRoyale && hungerM && CMD {
            lol.set(kills*12, forKey: "place")
        } else if damageM != 0 && !hungerM && CMD {
            lol.set(kills*5, forKey: "place")
        } else {
            lol.set(Double(kills)*2.5, forKey: "place")
        }
        if victoryRoyale {

...
class UNOViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        if pickerView.tag == 3 {
            if pickerData[row] == "Common Pistol" {
                ...
                three = "1M"
            } else if pickerData[row] == "Medic" {
                iamge.setBackgroundImage(UIImage(named: "meds"), for: .normal)
                three = "meds"
            } else if pickerData[row] == "Metal Sword" {
                iamge.setBackgroundImage(UIImage(named: "metal"), for: .normal)
                three = "metal"
            } else if pickerData[row] == "Laser Gun" {
                iamge.setBackgroundImage(UIImage(named: "laser"), for: .normal)
                three = "laser"
            }
        } else if pickerView.tag == 2 {
            if pickerData1[row] == "Common Pistol" {
                image2.setBackgroundImage(UIImage(named: "GreenPistolP"), for: .normal)
                two = "GreenPistolP"
            } else if pickerData1[row] == "Common Spear" {
                image2.setBackgroundImage(UIImage(named: "GreenSpearSP"), for: .normal)
                two = "GreenSpearSP"
            } else if pickerData1[row] == "Rare Machine Gun" {
                image2.setBackgroundImage(UIImage(named: "RareMachineG"), for: .normal)
                two = "RareMachineG"
            } else if pickerData1[row] == "Rare Spear"  {
                image2.setBackgroundImage(UIImage(named: "RareSpearSP"), for: .normal)
                two = "RareSpearSP"
            } else if pickerData1[row] == "Mythical Machine Gun" {
                image2.setBackgroundImage(UIImage(named: "MythicalMachineG"), for: .normal)
                two = "MythicalMachineG"
            } else if pickerData1[row] == "Mythical Shotgun" {
                image2.setBackgroundImage(UIImage(named: "MythicalShotgunG"), for: .normal)
                two = "MythicalShotgunG"
            } else if pickerData1[row] == "Epic Sniper" {
                image2.setBackgroundImage(UIImage(named: "EpicSniperG"), for: .normal)
                two = "EpicSniperG"
            } else if pickerData1[row] == "Epic Sword" {
                image2.setBackgroundImage(UIImage(named: "EpicSwordS"), for: .normal)
                two = "EpicSwordS"
            } else if pickerData1[row] == "Legendary Sniper" {
                image2.setBackgroundImage(UIImage(named: "LegendarySniperG"), for: .normal)
                two = "LegendarySniperG"
            } else if pickerData1[row] == "Legendary Sword" {
                image2.setBackgroundImage(UIImage(named: "LegendarySwordS"), for: .normal)
                two = "LegendarySwordS"
            } else if pickerData1[row] == "Mini Gun" {
                image2.setBackgroundImage(UIImage(named: "1M"), for: .normal)
                two = "1M"
            } else if pickerData1[row] == "Medic" {
                image2.setBackgroundImage(UIImage(named: "meds"), for: .normal)
                two = "meds"
            } else if pickerData1[row] == "Metal Sword" {
                image2.setBackgroundImage(UIImage(named: "metal"), for: .normal)
                two = "metal"
            } else if pickerData1[row] == "Laser Gun" {
                image2.setBackgroundImage(UIImage(named: "laser"), for: .normal)
                two = "laser"
            }
            ...
            if pickerData[row] == "Common Pistol" {
                ...
                image1.setBackgroundImage(UIImage(named: "meds"), for: .normal)
                one = "meds"
            } else if pickerData[row] == "Metal Sword" {
                image1.setBackgroundImage(UIImage(named: "metal"), for: .normal)
                one = "metal"
            } else if pickerData[row] == "Laser Gun" {
                image1.setBackgroundImage(UIImage(named: "laser"), for: .normal)
                one = "laser"
            }
        }
    }
    ...
    override func viewDidLoad() {
        ...
        pickerData1 = ["Common Pistol", "Common Spear", "Rare Machine Gun", "Rare Spear", "Mythical Machine Gun", "Mythical Shotgun", "Epic Sniper", "Epic Sword", "Legendary Sniper", "Legendary Sword", "Mini Gun", "Medic", "Metal Sword", "Laser Gun"]
        pickerData = ["Common Pistol", "Common Spear", "Rare Machine Gun", "Rare Spear", "Mythical Machine Gun", "Mythical Shotgun", "Epic Sniper", "Epic Sword", "Legendary Sniper", "Legendary Sword", "Mini Gun", "Metal Sword", "Laser Gun"]
